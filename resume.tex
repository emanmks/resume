    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Bug Prediction and Software Entropy}
          {Bug prediction with bug-caching methodology and software entropy calculation.}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{e-Procurement Platform}
          {From monolith to microservice architecture. Implementation of Dev-Ops for Continuous Delivery}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{SSO Security Enhancement}
          {Single sign on security enhancement to secure the BI Dashboard}
      \resumeItemListEnd
