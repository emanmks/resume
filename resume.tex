    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{GladiResik}
          {A rehearsal of online university submission in Indonesia. Used by more than 30,000 users.}
        \resumeItem{OneSchoolApp}
          {A web based application for a sme english course institutions in Indonesia.}
        \resumeItem{TaxIS}
